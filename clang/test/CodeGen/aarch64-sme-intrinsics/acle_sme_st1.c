...
void test_smst1h_u8(svbool_t pg, smuint8_t src, uint32_t idx, uint8_t *dest) {
  ...
  // CHECK: call void @llvm.aarch64.sme.st1.row.mxv256i8(<vscale x 16 x i1> %pg, <mscale x 256 x i8> %src, i32 %idx, i32 0, i8* %dest)
  // CHECK: ret void
...
void test_smst1h_u16(svbool_t pg, smuint16_t src, uint32_t idx, uint16_t *dest) {
  ...
  // CHECK: call void @llvm.aarch64.sme.st1.row.mxv64i16(<vscale x 8 x i1> %[[PG]], <mscale x 64 x i16> %src, i32 %idx, i32 0, i16* %dest)
  // CHECK: ret void
...
void test_smst1h_u32(svbool_t pg, smuint32_t src, uint32_t idx, uint32_t *dest) {
  ...
  // CHECK: call void @llvm.aarch64.sme.st1.row.mxv16i32(<vscale x 4 x i1> %[[PG]], <mscale x 16 x i32> %src, i32 %idx, i32 0, i32* %dest)
  // CHECK: ret void
...
void test_smst1h_u64(svbool_t pg, smuint64_t src, uint32_t idx, uint64_t *dest) {
  ...
  // CHECK: call void @llvm.aarch64.sme.st1.row.mxv4i64(<vscale x 2 x i1> %[[PG]], <mscale x 4 x i64> %src, i32 %idx, i32 0, i64* %dest)
  // CHECK: ret void
...
void test_smst1h_f16(svbool_t pg, smfloat16_t src, uint32_t idx, float16_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 8 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv8i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.row.mxv64f16(<vscale x 8 x i1> %[[PG]], <mscale x 64 x half> %src, i32 %idx, i32 0, half* %dest)
  // CHECK: ret void
...
void test_smst1h_f32(svbool_t pg, smfloat32_t src, uint32_t idx, float32_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 4 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv4i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.row.mxv16f32(<vscale x 4 x i1> %[[PG]], <mscale x 16 x float> %src, i32 %idx, i32 0, float* %dest)
  // CHECK: ret void
...
void test_smst1h_f64(svbool_t pg, smfloat64_t src, uint32_t idx, float64_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.row.mxv4f64(<vscale x 2 x i1> %[[PG]], <mscale x 4 x double> %src, i32 %idx, i32 0, double* %dest)
  // CHECK: ret void
...
void test_smst1v_u8(svbool_t pg, smuint8_t src, uint32_t idx, uint8_t *dest) {
  ...
  // CHECK: call void @llvm.aarch64.sme.st1.col.mxv256i8(<vscale x 16 x i1> %pg, <mscale x 256 x i8> %src, i32 %idx, i32 0, i8* %dest)
  // CHECK: ret void
...
void test_smst1v_u16(svbool_t pg, smuint16_t src, uint32_t idx, uint16_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 8 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv8i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.col.mxv64i16(<vscale x 8 x i1> %[[PG]], <mscale x 64 x i16> %src, i32 %idx, i32 0, i16* %dest)
  // CHECK: ret void
...
void test_smst1v_u32(svbool_t pg, smuint32_t src, uint32_t idx, uint32_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 4 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv4i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.col.mxv16i32(<vscale x 4 x i1> %[[PG]], <mscale x 16 x i32> %src, i32 %idx, i32 0, i32* %dest)
  // CHECK: ret void
...
void test_smst1v_u64(svbool_t pg, smuint64_t src, uint32_t idx, uint64_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.col.mxv4i64(<vscale x 2 x i1> %[[PG]], <mscale x 4 x i64> %src, i32 %idx, i32 0, i64* %dest)
  // CHECK: ret void
...
void test_smst1v_f16(svbool_t pg, smfloat16_t src, uint32_t idx, float16_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 8 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv8i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.col.mxv64f16(<vscale x 8 x i1> %[[PG]], <mscale x 64 x half> %src, i32 %idx, i32 0, half* %dest)
  // CHECK: ret void
...
void test_smst1v_f32(svbool_t pg, smfloat32_t src, uint32_t idx, float32_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 4 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv4i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.col.mxv16f32(<vscale x 4 x i1> %[[PG]], <mscale x 16 x float> %src, i32 %idx, i32 0, float* %dest)
  // CHECK: ret void
...
void test_smst1v_f64(svbool_t pg, smfloat64_t src, uint32_t idx, float64_t *dest) {
  ...
  // CHECK: %[[PG:.*]] = call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> %pg)
  // CHECK: call void @llvm.aarch64.sme.st1.col.mxv4f64(<vscale x 2 x i1> %[[PG]], <mscale x 4 x double> %src, i32 %idx, i32 0, double* %dest)
  // CHECK: ret void
