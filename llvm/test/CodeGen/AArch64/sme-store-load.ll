; RUN: llc -O0 -mtriple=aarch64-none-linux-gnu -mattr=+sme,+sve -asm-verbose=0 < %s -o - 2>%t | FileCheck %s
...
; CHECK-NEXT: st1b	{za0h.b{{\[}}w[[V]], 0{{\]}}}, [[PG]], {{\[}}sp, [[XM]]{{\]}}
...
; CHECK-NEXT: sub	x[[V]], x[[V]], #1
; CHECK-NEXT: sub	[[XM]], [[XM]], [[CNTB]]
; CHECK-NEXT: ld1b	{za0h.b{{\[}}w[[V]], 0{{\]}}}, [[PG]]/z, {{\[}}sp, [[XM]]{{\]}}
; CHECK-NEXT: cbz	x[[V]], .[[LOOP]]
...
; CHECK-NEXT: st1h	{za{{[0-1]}}h.h{{\[}}w[[V]], 0{{\]}}}, [[PG]], {{\[}}sp, [[XM]], lsl #1{{\]}}
; CHECK-NEXT: cbz	x[[V]], .[[LOOP]]
...
; CHECK-NEXT: sub	x[[V]], x[[V]], #1
; CHECK-NEXT: sub	[[XM]], [[XM]], [[CNTH]]
; CHECK-NEXT: ld1h	{za{{[0-1]}}h.h{{\[}}w[[V]], 0{{\]}}}, [[PG]]/z, {{\[}}sp, [[XM]], lsl #1{{\]}}
; CHECK-NEXT: cbz	x[[V]], .[[LOOP]]
...
; CHECK-NEXT: st1w	{za{{[0-1]}}h.s{{\[}}w[[V]], 0{{\]}}}, [[PG]], {{\[}}sp, [[XM]], lsl #2{{\]}}
; CHECK-NEXT: cbz	x[[V]], .[[LOOP]]
...
; CHECK-NEXT: sub	x[[V]], x[[V]], #1
; CHECK-NEXT: sub	[[XM]], [[XM]], [[CNTB]]
; CHECK-NEXT: ld1w	{za{{[0-1]}}h.s{{\[}}w[[V]], 0{{\]}}}, [[PG]]/z, {{\[}}sp, [[XM]], lsl #2{{\]}}
; CHECK-NEXT: cbz	x[[V]], .[[LOOP]]
...
; CHECK-NEXT: st1d	{za{{[0-1]}}h.d{{\[}}w[[V]], 0{{\]}}}, [[PG]], {{\[}}sp, [[XM]], lsl #3{{\]}}
; CHECK-NEXT: cbz	x[[V]], .[[LOOP]]
...
; CHECK-NEXT: sub	x[[V]], x[[V]], #1
; CHECK-NEXT: sub	[[XM]], [[XM]], [[CNTD]]
; CHECK-NEXT: ld1d	{za{{[0-1]}}h.d{{\[}}w[[V]], 0{{\]}}}, [[PG]]/z, {{\[}}sp, [[XM]], lsl #3{{\]}}
; CHECK-NEXT: cbz	x[[V]], .[[LOOP]]
...
; CHECK-NEXT: sub       x[[V]], x[[V]], #1
; CHECK-NEXT: sub       [[XM]], [[XM]], [[CNTD]]
; CHECK-NEXT: st1q      {za0h.q{{\[}}w[[V]], 0{{\]}}}, [[PG]], {{\[}}sp, [[XM]], lsl #4{{\]}}
; CHECK-NEXT: cbz       x[[V]], .[[LOOP]]
; CHECK-NEXT: ptrue     [[PG:p[0-7]]].d
; CHECK-NEXT: cntd      [[CNTD:x[0-9]+]]
; CHECK-NEXT: asr       [[CNTD]], [[CNTD]], #1
...
; CHECK-NEXT: sub       x[[V]], x[[V]], #1
; CHECK-NEXT: sub       [[XM]], [[XM]], [[CNTD]]
; CHECK-NEXT: ld1q      {za0v.q{{\[}}w[[V]], 0{{\]}}}, [[PG]]/z, {{\[}}sp, [[XM]], lsl #4{{\]}}
; CHECK-NEXT: cbz       x[[V]], .[[LOOP]]
